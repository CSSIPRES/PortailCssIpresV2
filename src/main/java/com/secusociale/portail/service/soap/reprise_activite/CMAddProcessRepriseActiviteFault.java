...
public class CMAddProcessRepriseActiviteFault
    extends Exception
{
     ...
     * @param message
     */
    public CMAddProcessRepriseActiviteFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param message
     */
    public CMAddProcessRepriseActiviteFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
