 ...
 * 
 */
@WebServiceClient(name = "CM_GET_PAYMENT_URLService", targetNamespace = "http://ouaf.oracle.com/spl/XAIXapp/xaiserver/CM_GET_PAYMENT_URL", wsdlLocation = "http://192.168.125.23:7500/ouaf/XAIApp/xaiserver/CM_GET_PAYMENT_URL?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.125.23:7500/ouaf/XAIApp/xaiserver/CM_GET_PAYMENT_URL?WSDL");
     ...
     * 
     * @return
     *     returns CMGETPAYMENTURLPortType
     */
