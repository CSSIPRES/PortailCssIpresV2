...
public class CMGETFACTURE {
    ...
    protected CMGETFACTURE.Input input;
    @XmlElement(namespace = "http://oracle.com/CM_GET_FACTURE.xsd")
    protected CMGETFACTURE.Output output;
     ...
     * @return
     *     possible object is
     *     {@link CMGETFACTURE.Input }
     *     
     */
    public CMGETFACTURE.Input getInput() {
        return input;
    }
     ...
     *     
     */
    public void setInput(CMGETFACTURE.Input value) {
        this.input = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link CMGETFACTURE.Output }
     *     
     */
    public CMGETFACTURE.Output getOutput() {
        return output;
    }
     ...
     *     
     */
    public void setOutput(CMGETFACTURE.Output value) {
        this.output = value;
    }
