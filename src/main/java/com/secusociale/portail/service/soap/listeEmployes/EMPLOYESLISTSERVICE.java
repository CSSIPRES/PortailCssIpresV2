...
public class EMPLOYESLISTSERVICE {
    ...
    protected EMPLOYESLISTSERVICE.Input input;
    @XmlElement(namespace = "http://oracle.com/EMPLOYES_LIST_SERVICE.xsd")
    protected List<EMPLOYESLISTSERVICE.Output> output;
     ...
     * @return
     *     possible object is
     *     {@link EMPLOYESLISTSERVICE.Input }
     *     
     */
    public EMPLOYESLISTSERVICE.Input getInput() {
        return input;
    }
     ...
     *     
     */
    public void setInput(EMPLOYESLISTSERVICE.Input value) {
        this.input = value;
    }
     ...
     * {@link EMPLOYESLISTSERVICE.Output }
     * 
     * 
     */
    public List<EMPLOYESLISTSERVICE.Output> getOutput() {
        if (output == null) {
            output = new ArrayList<EMPLOYESLISTSERVICE.Output>();
        }
        return this.output;
    }
