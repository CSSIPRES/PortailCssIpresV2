...
describe('Service Tests', () => {
  describe('Paiement Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Paiement(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 0, 0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Paiement', () => {
        const returnedFromService = Object.assign(
          {
            numeroOrdreVirement: 'BBBBBB',
            banqueSource: 'BBBBBB',
            numeroCompteSource: 'BBBBBB',
            banqueDestination: 'BBBBBB',
            numeroCompteDestination: 'BBBBBB',
            referenceFacture: 'BBBBBB',
            montantTotal: 1,
            montantAccount: 1,
            etat: 'BBBBBB',
            fileJoin: 'BBBBBB'
